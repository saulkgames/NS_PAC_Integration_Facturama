...
<#if transaction.tranid?string?substring(0,1)== "B">
<fx:Serie>B</fx:Serie>
<fx:Folio>${transaction.tranid?string?remove_beginning("B")}</fx:Folio></#if>
<#if transaction.tranid?string?substring(0,1)== "C">
<fx:Serie>C</fx:Serie>
<fx:Folio>${transaction.tranid?string?remove_beginning("B")}</fx:Folio>
</#if>

 ...
 * @NModuleScope Public
 *
 * SADS Facturama - Lógica compartida del flujo de Facturación Global.
 * Provee la consulta de transacciones, la resolución de archivos y las etiquetas de la UI.
 */
define(['N/search', 'N/config', 'N/record', 'N/log'],
    ...
    function (search, config, record, log) {
        ...
        /**
         * Consulta las Cash Sales candidatas a facturación global según los filtros de la UI.
         * @param {Object} params - Filtros de búsqueda.
         * @param {string} params.subsidiary - ID de la subsidiaria.
         * @param {string} params.datesearch - Fecha inicial del rango.
         * @param {string} params.datesearche - Fecha final del rango.
         * @param {string} params.customer - ID del cliente.
         * @param {string} [params.paymentm] - Método de pago SAT (se omite si es '0' o vacío).
         * @returns {Array} Arreglo de transacciones con id, tipo, fecha, folio, importe, cliente y creador.
         */
        function getAllTransaction(params) {
            ...
            try {
                ...
                // El parámetro del Suitelet (params.paymentm) se mapea al método de pago SAT de la transacción
        ...
        /**
         * Obtiene el ID interno de un archivo del File Cabinet a partir de su nombre.
         * @param {string} filename - Nombre del archivo a buscar.
         * @returns {number|null} ID interno del archivo, o null si no existe.
         */
        ...
        /**
         * Devuelve las etiquetas de la UI en español o inglés según la preferencia de idioma del usuario.
         * @returns {Object} Diccionario de etiquetas localizadas.
         */
